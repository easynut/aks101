...
This lab is an introduction to using Docker containers on Kubernetes in the IBM Kubernetes Service. By the end of the course, you'll achieve these objectives:
* Understand core concepts of Kubernetes
* Build a Docker image and deploy an application on Kubernetes in the IBM Kubernetes Service
...
IBM Cloud provides the capability to run applications in containers on Kubernetes. The IBM Kubernetes Service runs Kubernetes clusters which deliver the following:
...
[Lab 2](Lab2): Builds on lab 1 to expand to a more resilient setup which can survive having containers fail and recover. Lab 2 will also walk through basic services you need to get started with Kubernetes and the IBM Kubernetes Service
